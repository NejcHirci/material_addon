...
def init_global_noise(imres, init_from):
     ...
     if init_from == 'random':
          ...
          if os.path.exists(init_from):
               noises_list = th.load(init_from) if th.cuda.is_available() else th.load(init_from, map_location=th.device('cpu'))
     ...
     if th.cuda.is_available():
          ...
          noise_4_2 = Variable(noise_4_2, requires_grad=True)
          noise_8_1 = Variable(noise_8_1, requires_grad=True)
          noise_8_2 = Variable(noise_8_2, requires_grad=True)
          noise_16_1 = Variable(noise_16_1, requires_grad=True)
          noise_16_2 = Variable(noise_16_2, requires_grad=True)
          noise_32_1 = Variable(noise_32_1, requires_grad=True)
          noise_32_2 = Variable(noise_32_2, requires_grad=True)
          noise_64_1 = Variable(noise_64_1, requires_grad=True)
          noise_64_2 = Variable(noise_64_2, requires_grad=True)
          noise_128_1 = Variable(noise_128_1, requires_grad=True)
          noise_128_2 = Variable(noise_128_2, requires_grad=True)
          noise_256_1 = Variable(noise_256_1, requires_grad=True)
          noise_256_2 = Variable(noise_256_2, requires_grad=True)
