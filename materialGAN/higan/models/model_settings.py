...
MODEL_POOL = {
    ...
    'svbrdf': {
        'weight_path': 'materialGAN/data/pretrain/pytorch/svbrdf.pth',
        'tf_weight_path': 'materialGAN/data/pretrain/tensorflow/svbrdf.pkl',
        'tf_code_path': os.path.join(BASE_DIR, 'stylegan2_tf_official'),
        'gan_type': 'stylegan2',
        'dataset_name': 'svbrdf',
        'z_space_dim': 512,
...
STYLEGAN2_TRUNCATION_PSI = 1.0  # 1.0 means no truncation
